...
import AWS from "../assets/typescript.jpg";
import GitHub from "../assets/github.png";
import Tailwind from "../assets/tailwind.png";
import NEXT from "../assets/person.next.jpg";

const Skill = () => {
  return (
    <div name="skills" className="w-full h-screen bg-[#0a192f] text-gray-300">
      {/*container */}
      <div className="max-w-[1000px] mx-auto p-4 flex flex-cols justify-center w-full h-full">
        <div>
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8">
          ...
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            <img className="w-20 mx-auto" src={AWS} alt="icon" />
